...
class TextHelper:
    ...
    def putText(self, frame, text, coords):
        cv2.putText(frame, text, coords, self.text_type, 0.5, self.bg_color, 6, self.line_type)
    ...
    while True:
        ...
        if inRgb is not None:
            ...
            if counters is not None:
                text.putText(frame, f"Detected: {counters['Detection']}, In: {counters['In']}, DelBox: {counters['DelX']}, Angle: {counters['Theta']}", (1, 30)) #, cv2.FONT_HERSHEY_TRIPLEX, 0.5, 255)
