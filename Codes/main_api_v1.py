...
objectTracker.setDetectionLabelsToTrack([1])  # Track vehicle
...
with dai.Device(pipeline) as device:
    ...
    def displayFrame(name, frame, detections):
        ...
        for detection in detections:
            ...
            cv2.putText(frame, f"{int(detection.confidence * 100)}% limits = {float(detection.xmin):.2f}", (bbox[0] + 10, bbox[1] + 40), cv2.FONT_HERSHEY_TRIPLEX, 0.5, 255)
